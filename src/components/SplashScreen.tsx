...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-[600px] flex flex-col items-center justify-between p-8 bg-[#0B1120] text-white select-none overflow-hidden">
      ...
      <div className="w-full flex justify-end pt-2">
        <button 
          ...
          className="text-xs text-slate-400 hover:text-white px-3 py-1.5 rounded-full bg-slate-800/60 backdrop-blur-md border border-slate-700/50 transition-colors cursor-pointer active:scale-95"
        >
          Skip
        </button>
      </div>
      ...
      >
        <div className="relative group">
          ...
          <div className="relative bg-slate-950 p-3 rounded-2xl border border-cyan-500/30 shadow-2xl">
