import{_ as Ut,g as Dt,a as Ln,b as Un,c as m,d as y,e as $e,i as Ke,p as Dn,q as Y,f as te,h as ne,F as ze,E as Je,j as Mn,k as Vn,l as Wn,L as Fn,m as Mt,S as de,n as k,o as xn,r as Hn,D as Gn,s as $n,t as jn,u as ct,C as lt,v as ut,w as qn,W as Bn,P as q,x as ge}from"./index-B6CY6C_S.js";function Vt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Kn=Vt,Wt=new Je("auth","Firebase",Vt());/**
 * @license
 ...
 */const Te=new Fn("@firebase/auth");function Ft(n,...e){Te.logLevel<=Mt.WARN&&Te.warn(`Auth (${de}): ${n}`,...e)}function we(n,...e){Te.logLevel<=Mt.ERROR&&Te.error(`Auth (${de}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zn(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Qe()||$n()||"connection"in navigator)?navigator.onLine:!0}function Jn(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cr(n,e){const t=await Ht(n,{},async()=>{const r=Y({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=n.config,o=await Gt(n,i,"/v1/token",`key=${s}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:r};return n.emulatorConfig&&Ke(n.emulatorConfig.host)&&(c.credentials="include"),xt.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function lr(n,e){return w(n,"POST","/v2/accounts:revokeToken",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nn(n,e=[]){let t;switch(n){case"Browser":t=gt(k());break;case"Worker":t=`${gt(k())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${de}/${r}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ci(n,e,t){const r=R(n),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){l(a.handleCodeInApp,r,"argument-error"),a&&Ue(r,o,a)}s(i,t),await G(r,i,"getOobCode",Hr,"EMAIL_PASSWORD_PROVIDER")}function li(n,e){const t=be.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function ui(n,e,t){if(y(n.app))return Promise.reject(T(n));const r=m(n),i=W.credentialWithLink(e,t||ce());return l(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),nt(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(n,e){return m(n).setPersistence(e)}function ki(n,e,t,r){return m(n).onIdTokenChanged(e,t,r)}function vi(n,e,t){return m(n).beforeAuthStateChanged(e,t)}function Si(n,e){return R(n).revokeAccessToken(e)}async function Ci(n){return m(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(n,e){return w(n,"POST","/v2/accounts/mfaEnrollment:start",_(n,e))}const ve="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=oe._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function zi(n,e,t){if(y(n.app))return Promise.reject(T(n));const r=R(n),i=await Pn(r,e,m(t));return new Tn(i,s=>nt(r,s))}async function Ji(n,e,t){const r=m(n);await Le(!1,r,"phone");const i=await Pn(r.auth,e,m(t));return new Tn(i,s=>dn(r,s))}async function Pn(n,e,t){var r;if(!n._getRecaptchaConfig())try{await Nr(n)}catch{}try{let i;if(typeof e=="string"?i={phoneNumber:e}:i=e,"session"in i){const s=i.session;if("phoneNumber"in i){l(s.type==="enroll",n,"internal-error");const o={idToken:s.credential,phoneEnrollmentInfo:{phoneNumber:i.phoneNumber,clientType:"CLIENT_TYPE_WEB"}};return(await G(n,o,"mfaSmsEnrollment",async(d,f)=>{if(f.phoneEnrollmentInfo.captchaResponse===se){l((t==null?void 0:t.type)===ae,d,"argument-error");const E=await He(d,f,t);return Rt(d,E)}return Rt(d,f)},"PHONE_PROVIDER").catch(d=>Promise.reject(d))).phoneSessionInfo.sessionInfo}else{l(s.type==="signin",n,"internal-error");const o=((r=i.multiFactorHint)==null?void 0:r.uid)||i.multiFactorUid;l(o,n,"missing-multi-factor-info");const a={mfaPendingCredential:s.credential,mfaEnrollmentId:o,phoneSignInInfo:{clientType:"CLIENT_TYPE_WEB"}};return(await G(n,a,"mfaSmsSignIn",async(f,E)=>{if(E.phoneSignInInfo.captchaResponse===se){l((t==null?void 0:t.type)===ae,f,"argument-error");const j=await He(f,E,t);return kt(f,j)}return kt(f,E)},"PHONE_PROVIDER").catch(f=>Promise.reject(f))).phoneResponseInfo.sessionInfo}}else{const s={phoneNumber:i.phoneNumber,clientType:"CLIENT_TYPE_WEB"};return(await G(n,s,"sendVerificationCode",async(u,d)=>{if(d.captchaResponse===se){l((t==null?void 0:t.type)===ae,u,"argument-error");const f=await He(u,d,t);return Et(u,f)}return Et(u,d)},"PHONE_PROVIDER").catch(u=>Promise.reject(u))).sessionInfo}}finally{t==null||t._reset()}}async function He(n,e,t){l(t.type===ae,n,"argument-error");const r=await t.verify();l(typeof r=="string",n,"argument-error");const i={...e};if("phoneEnrollmentInfo"in i){const s=i.phoneEnrollmentInfo.phoneNumber,o=i.phoneEnrollmentInfo.captchaResponse,a=i.phoneEnrollmentInfo.clientType,c=i.phoneEnrollmentInfo.recaptchaVersion;return Object.assign(i,{phoneEnrollmentInfo:{phoneNumber:s,recaptchaToken:r,captchaResponse:o,clientType:a,recaptchaVersion:c}}),i}else if("phoneSignInInfo"in i){const s=i.phoneSignInInfo.captchaResponse,o=i.phoneSignInInfo.clientType,a=i.phoneSignInInfo.recaptchaVersion;return Object.assign(i,{phoneSignInInfo:{recaptchaToken:r,captchaResponse:s,clientType:o,recaptchaVersion:a}}),i}else return Object.assign(i,{recaptchaToken:r}),i}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kn{constructor(e,t,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Yi;case"linkViaPopup":case"linkViaRedirect":return Qi;case"reauthViaPopup":case"reauthViaRedirect":return Xi;default:A(this.auth,"internal-error")}}resolve(e){V(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){V(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ns="pendingRedirect",ye=new Map;class rs extends kn{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ye.get(this.auth._key());if(!e){try{const r=await is(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ye.set(this.auth._key(),e)}return this.bypassAuthState||ye.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function is(n,e){const t=Cn(e),r=Sn(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}async function vn(n,e){return Sn(n)._set(Cn(e),"true")}function ss(n,e){ye.set(n._key(),e)}function Sn(n){return M(n._redirectPersistence)}function Cn(n){return Ee(ns,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function os(n,e,t){return as(n,e,t)}async function as(n,e,t){if(y(n.app))return Promise.reject(T(n));const r=R(n);Ce(n,e,X),await r._initializationPromise;const i=me(r,t);return await vn(i,r),i._openRedirect(r,e,"signInViaRedirect")}function cs(n,e,t){return ls(n,e,t)}async function ls(n,e,t){const r=m(n);Ce(r.auth,e,X),await r.auth._initializationPromise;const i=me(r.auth,t);await Le(!1,r,e.providerId),await vn(i,r.auth);const s=await ds(r);return i._openRedirect(r.auth,e,"linkViaRedirect",s)}async function us(n,e){return await R(n)._initializationPromise,Nn(n,e,!1)}async function Nn(n,e,t=!1){if(y(n.app))return Promise.reject(T(n));const r=R(n),i=me(r,e),o=await new rs(r,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}async function ds(n){const e=Me(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vs="__/auth/handler",Ws="emulator/auth/handler",Fs=encodeURIComponent("fac");async function At(n,e,t,r,i,s){l(n.config.authDomain,n,"auth-domain-config-required"),l(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:de,eventId:i};if(e instanceof X){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Hn(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,f]of Object.entries({}))o[d]=f}if(e instanceof Q){const d=e.getScopes().filter(f=>f!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const c=await n._getAppCheckToken(),u=c?`#${Fs}=${encodeURIComponent(c)}`:"";return`${xs(n)}?${Y(a).slice(1)}${u}`}function xs({config:n}){return n.emulator?Ze(n,Ws):`https://${n.authDomain}/${Vs}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
