import{v as _,u as R,C,_ as q,E as fe,y as H,F as Be,z as Ve,B as We,G as Ge,c as D,b as Je,H as A,W as ze}from"./index-B6CY6C_S.js";const le="@firebase/installations",L="0.6.24";/**
 * @license
 ...
 */const pe=1e4,ge=`w:${L}`,he="FIS_v2",Ye="https://firebaseinstallations.googleapis.com/v1",Qe=3600*1e3,Xe="installations",Ze="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ne="installations",Ot="installations-internal",Ft=e=>{const t=e.getProvider("app").getImmediate(),n=Dt(t),i=q(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},Mt=e=>{const t=e.getProvider("app").getImmediate(),n=q(t,Ne).getImmediate();return{getId:()=>_t(n),getToken:o=>Rt(n,o)}};function Pt(){R(new C(Ne,Ft,"PUBLIC")),R(new C(Ot,Mt,"PRIVATE"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kt="/firebase-messaging-sw.js",xt="/firebase-cloud-messaging-push-scope",De="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",$t="https://fcmregistrations.googleapis.com/v1",Oe="google.c.a.c_id",jt="google.c.a.c_l",qt="google.c.a.ts",Ht="google.c.a.e",Z=1e4;var ee;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(ee||(ee={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne="firebase-messaging-database",ie=2,p="firebase-messaging-store",l="firebase-messaging-fid-registration-store",Wt={openDB:H,deleteDB:A};let oe=Wt,k=null;function Gt(e,t,n){switch(t){case 0:if(e.createObjectStore(p),n===1)break;case 1:n===2&&e.createObjectStore(l)}}function re(e){return{upgrade:(t,n)=>{Gt(t,n,e)},blocked:()=>{},blocking:(t,n,i)=>{var o;k=null,(o=i.target)==null||o.close()},terminated:()=>{k=null}}}function T(){return k||(k=oe.openDB(ne,ie,re(2)).catch(()=>oe.openDB(ne,ie-1,re(1)))),k}function Me(e,t){return e.objectStoreNames.contains(t)}function W(e){if(!Me(e,l))throw c.create("fid-registration-idb-schema-unavailable")}async function Pe(e){const t=I(e),i=await(await T()).transaction(p).objectStore(p).get(t);if(i)return i;{const o=await Ut(e.appConfig.senderId);if(o)return await G(e,o),o}}async function G(e,t){const n=I(e),i=await T(),o=[p],r=Me(i,l);r&&o.push(l);const a=i.transaction(o,"readwrite");return await a.objectStore(p).put(t,n),r&&await a.objectStore(l).delete(n),await a.done,t}async function Jt(e){const t=I(e),i=(await T()).transaction(p,"readwrite");await i.objectStore(p).delete(t),await i.done}async function J(e){const t=I(e),n=await T();return W(n),await n.transaction(l).objectStore(l).get(t)}async function zt(e,t){const n=I(e),i=await T();W(i);const o=i.transaction([p,l],"readwrite");return await o.objectStore(l).put(t,n),await o.objectStore(p).delete(n),await o.done,t}async function Yt(e){const t=I(e),n=await T();W(n);const i=n.transaction(l,"readwrite");await i.objectStore(l).delete(t),await i.done}function I({appConfig:e}){return e.appId}const ae="@firebase/messaging",j="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sn(e,t){return Nt(t,()=>{(async()=>!e.onRegisteredHandler||!await J(e.firebaseDependencies)||await He(e).catch(()=>{}))()})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Le(e,t){if(!navigator)throw c.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw c.create("permission-blocked");return await qe(e,t==null?void 0:t.vapidKey),await je(e,t==null?void 0:t.serviceWorkerRegistration),un(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dn(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;if(e.onMessageHandler&&n.messageType===y.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(de(n)):e.onMessageHandler.next(de(n))),e.onRegisteredHandler&&n.messageType===y.FID_REGISTERED){const o=n.fid;typeof e.onRegisteredHandler=="function"?e.onRegisteredHandler(o):e.onRegisteredHandler.next(o)}const i=n.data;An(i)&&i[Ht]==="1"&&await Cn(e,n.messageType,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function S(){try{await Ve()}catch{return!1}return typeof window<"u"&&We()&&Ge()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x(e=Je()){return S().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),q(D(e),"messaging").getImmediate()}async function xn(e,t){return e=D(e),Le(e,t)}function $n(e){return e=D(e),Pn(e)}function jn(e,t){return e=D(e),Kn(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
